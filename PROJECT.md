...
- 2026-05-02: Scroll-Animation smooth gemacht — Frame-Swap via `<img>.src` ersetzt durch `<canvas>` + vorgeladene Image-Objekte im Array (kein GC, kein Re-Decode beim Scrollen, kein Flicker zwischen Frames). DPR-aware Canvas-Sizing für scharfes Rendering, Fallback zum nächst-besten geladenen Frame falls Idx noch nicht decoded → Animation verschwindet nicht mehr und läuft butter-smooth auf Laptop/Desktop
